...
description: "Standalone LLM router utility with ML classification, semantic caching, streaming, and multi-provider support. Tested with 200 training examples and 100 test queries."
...
```
Total Queries: 100
Routing Accuracy: 40-50% (84% simple, 96% moderate, 8% complex, 0% reasoning)
Cache Hit Rate: 0% (cold start), >90% after cache populated
...
```typescript
// Similar queries match semantically after cache population
